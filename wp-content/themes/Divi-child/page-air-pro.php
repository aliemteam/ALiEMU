    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class('category-air-pro'); ?>>
        <div class="au-card">
            ...
            <div class="au-content">
                <div class="au-text">
                    <div>
                        Welcome to the <a href="">Approved Instructional Resources Professional (AIR-Pro) series</a>! This series screens and grades open access blog posts and podcasts in the field of emergency medicine (EM) to identify high quality, social media-based, educational resources for senior EM residents. Unlike the AIR-Series, this series targets more advanced practitioners and is no longer limited to content published with the past 12 months. This series fulfills <a href="">Individualized Interactive Instruction (III)</a>, or asynchronous online learning, conference needs. Below are the AIR-Pro blocks listed in reverse chronological order along with their suggested number of III conference hour credit. If you are a program director and wish to track your residents’ progress, please sign up for our Educator Dashboard access.
                    </div>
                </div>
                <div class="au-image">
