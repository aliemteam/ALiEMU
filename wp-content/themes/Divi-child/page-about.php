            ...
            <div class="au-about-body">
                ...
                <section id="au-about-content" class="au-group">
                    ...
                    <div>
                        ...
                        <p>Educational institutions and organizations are increasingly awarding course completion credit and competency certificates for e-courses. Specifically, the Council of Residency Directors (CORD) in EM and the Accreditation Council for Graduate Medical Education (ACGME), have sought to broaden the types of educational experiences available to residents. Previous to 2008, five hours of synchronous educational conference time was required for U.S. EM residents per week for didactics. However, through recognition of the importance of asynchronous learning, the ACGME now  (ACGME PDF) allows residencies to replace up to 20% of their traditional conference time with asynchronous learning outside the classroom. This asynchronous learning opportunity has been termed Individualized Interactive Instruction (III).</p>
                ...
                <section id="au-about-air-pro" class="au-group">
                    ...
                    <div id="au-about-air-pro-creation" class="au-subgroup">
                        ...
                        <p>We created this series because the AIR-Series has clearly filled a niche for III credit at over 80 U.S. EM residency programs. Many programs however still struggle to identify more appropriate content for more senior residents, beyond the AIR series content. Following Vygotsky’s zone of proximal development educational theory, this series provides more advanced content to help the senior resident stretch his/her knowledge base beyond foundational content.</p>
                    ...
                    <div id="au-about-air-pro-different" class="au-subgroup">
                        ...
                        <p>There are 2 areas where the AIR-Pro scoring instrument differs from the previous AIR Series instrument.</p>
                        <ol>
                            <li>We replaced the Best Evidence in Emergency Medicine (BEEM) domain with Recency. Based on our experience with the AIR Series, we observed that many high-quality, advanced-level blogs and podcasts were older than 12 months. AIR’s 12 month cut-off was created partly to avoid impractically long lists of blog posts and podcasts to review each month. Because the AIR-Pro Series concentrates on very focused questions, we removed this timeframe cutoff and instead just reward more recently published posts with a higher Recency score.</li>
                            <li>The Educational Utility domain specifically targeted senior residents and not just residents in general in order to identify more advanced level educational content.</li>
                        </ol>
                    </div>
                    <div id="au-about-air-pro-labels" class="au-subgroup">
                        ...
                        <p>In an effort to truly emphasize the highest quality posts, we have two subsets of recommended resources. The AIR-Pro stamp of approval will only be given to posts scoring above a strict scoring cut-off of ≥28 points (out of 35 total), based on our AIR-Pro scoring instrument, which is slightly different from our original AIR Series scoring instrument. The other subset is for “Honorable Mention” posts. These posts have been flagged by and agreed upon by AIR-Pro Board members as worthwhile, accurate, unbiased, appropriately referenced, and have a score of 26-27. All posts will still be part of the quiz needed to obtain III credit. To decrease the repetitive nature of posts relating to these advanced concepts, we did not always include every post found that met the score of ≥ 28 points.</p>
                    </div>
                </section>
                <!-- Capsules -->
                <section id="au-about-capsules" class="au-group">
                    ...
                    <div id="au-about-capsules-creation" class="au-subgroup">
                        ...
                        <img src="https://pbs.twimg.com/media/B4FjicsCEAAPYDE.png">
