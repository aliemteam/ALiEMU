	...
	<div class="entry-content">
			...
			<div class="au-container">
				<div class="au-info-card">
					...
					<div class="au-info-text">
						<p>This page is intended for those with faculty appointments at U.S. Emergency Medicine residency programs. We welcome all learners to use and learn from ALiEMU, however we have built features that are only intended for U.S. Emergency Medicine faculty accounts. If you are are not a faculty representative at a U.S. Emergency Medicine residency program, then <a href="./#row-4">click here</a> to return to the general registration page. We hope to offer our special educator features to international residency programs in the future.</p>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="au-container">
				<div class="au-info-card">
					...
					<div class="au-info-text">
						...
						<ol>
							<li><a href="#row-7">Register</a> for a special faculty account</li>
		...
		<div id="row-5">
			<div class="au-container">
				<div class="au-info-card">
					<div class="au-info-header">
						<h1>How does this count for III credit?</h1>
					</div>
					<div class="au-info-text">
						...
						<ol>
							...
							<li>There must be an evaluation component. – We include quizzes for each module.</li>
