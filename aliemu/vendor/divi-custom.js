...
(function($) {
    ...
    $(document).ready(function() {
        ...
        $et_top_menu.find('li.mega-menu').each(function() {
            var $li_mega_menu = $(this),
                $li_mega_menu_item = $li_mega_menu
                    .children('ul')
                    .children('li'),
            ...
            if (li_mega_menu_item_count < 4) {
                $li_mega_menu.addClass(
                    'mega-menu-parent mega-menu-parent-' +
                        li_mega_menu_item_count,
                );
            }
        });
        ...
        window.et_calculate_header_values = function() {
            ...
            et_header_height =
                parseInt($('#main-header').innerHeight()) +
                secondary_nav_height;
            et_header_modifier = et_header_height <= 90
                ? et_header_height - 29
                : et_header_height - 56;
        ...
        function et_page_load_scroll_to_anchor() {
            ...
            var distance = 'undefined' !== typeof $target.offset().top
                ? $target.offset().top
                : 0,
               ...
               */
                    ...
                    if ($et_pb_first_row_first_module.is('.et_pb_slider')) {
                        ...
                        $et_pb_first_row_first_module
                            .find('.et_pb_slide')
                            .each(function() {
                                var $et_pb_first_row_first_module_slide_item = $(
                                    this,
                                ),
                    ...
                    var saved_custom_padding = $et_pb_first_row.attr(
                        'data-padding',
                    ),
                        ...
                        saved_custom_padding_phone = $et_pb_first_row.attr(
                            'data-padding-phone',
                        ),
                    ...
                    if (
                        ...
                        $et_pb_first_row.css({
                            paddingTop:
                                header_height + applied_saved_custom_padding,
                        });
                    } else {
        ...
        $(window).resize(function() {
            var window_width = parseInt($et_window.width()),
                ...
                et_container_width_in_pixel = typeof et_container_css_width !==
                    'undefined'
                    ? et_container_css_width.substr(-1, 1) !== '%'
                    : '',
                et_container_actual_width = et_container_width_in_pixel
                    ? parseInt($et_container.width())
                    : parseInt($et_container.width()) / 100 * window_width, // $et_container.width() doesn't recognize pixel or percentage unit. It's our duty to understand what it returns and convert it properly
                ...
                if (et_is_fixed_nav) {
                    if (
                        ...
                        if ($et_pb_first_row.is('.et_pb_fullwidth_section')) {
                            $waypoint_selector = $et_pb_first_row.children(
                                '.et_pb_module',
                            );
                        } else {
                            $waypoint_selector = $et_pb_first_row.find(
                                '.et_pb_row',
                            );
                        }
                    } else if (
                    ...
                    $waypoint_selector.waypoint({
                        offset: function() {
                            ...
                            if (et_hide_nav) {
                                return (
                                    et_header_offset - et_header_height - 200
                                );
                            } else {
                        ...
                        handler: function(direction) {
                            ...
                            if (direction === 'down') {
                                ...
                                $main_container_wrapper.addClass(
                                    'et-animated-content',
                                );
                                ...
                                if (
                                    ...
                                    $clone_header = $main_header
                                        .clone()
                                        .addClass(
                                            'et-fixed-header, et_header_clone',
                                        )
                                        .css({
                                            transition: 'none',
                                            display: 'none',
        ...
        window.et_pb_window_side_nav_scroll_init = function() {
            ...
            var top_header_height = $('#top-header').length > 0
                ? parseInt($('#top-header').height())
                : 0;
            var main_header_height = $('#main-header').length > 0
            ...
            for (var link = 0; link <= total_links; link++) {
                ...
                var target_offset = false === at_top_of_page
    ...
    function et_fix_logo_transition(is_onload) {
        ...
        if (is_header_split && !window.et_is_vertical_nav) {
            ...
            logo_wrapper_width =
                logo_actual_width * (logo_wrapper_height / logo_actual_height);
    ...
    $(
        '.et_pb_fullscreen_nav_container',
    ).on('click', 'li.menu-item-has-children > a', function() {
